...
//     // Add user message
//     setMessages((prev) => [...prev, { text: inp, sender: "user" }]);

//     // Simulate bot reply
//     setTimeout(() => {
//       setMessages((prev) => [...prev, { text: inp, sender: "bot" }]);
//     }, 500);
//   };
...
//       <Text className="text-2xl font-JakartaBold my-5">Chatting With Hadas AI</Text>
//       <FlatList
//         data={messages}
//         keyExtractor={(item, index) => index.toString()}
//         renderItem={({ item }) => (
//           <View className={`p-2 my-1 rounded-lg ${item.sender === "user" ? "bg-blue-300 self-end" : "bg-gray-300 self-start"}`}>
