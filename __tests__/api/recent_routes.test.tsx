import { POST } from "../../app/(api)/recent_routes+api";
...
describe("POST Get Recent Routes API", () => {
  ...
  it("returns 200 with recent routes when data is found", async () => {
    const fakeRoutes = [
      {
        route_id: 1,
  ...
  it("returns 200 with an empty array when no routes are found", async () => {
