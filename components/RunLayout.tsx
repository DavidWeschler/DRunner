...
const RunLayout = ({ title, snapPoints, children }: { title: string; snapPoints?: string[]; children: React.ReactNode }) => {
    ...
    <GestureHandlerRootView className="flex-1">
      <View className="flex-1 bg-white">
        <View className="flex flex-col h-screen bg-blue-500">
          <View className="flex flex-row absolute z-10 top-9 items-center justify-start px-5">
